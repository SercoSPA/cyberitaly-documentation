...
# 1. IAM Logins
# -----------------------------------------------------------------------------
echo "[$(date)][iam] Starting check...."
python3 "${PATH_SCRIPT}/kpi_iride_keycloak_events_iride_elastic.py"
echo "[$(date)][iam] Check completed"

sleep 10

# -----------------------------------------------------------------------------
# 2. IAM User statistics
# -----------------------------------------------------------------------------
echo "[$(date)][iam] Starting check...."
python3 "${PATH_SCRIPT}/kpi_iride_keycloak_user_statistics_iride_elastic.py"
echo "[$(date)][iam] Check completed"
