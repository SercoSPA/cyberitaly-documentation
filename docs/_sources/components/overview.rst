...
The following key concepts are used throughout these pages:
...
- **Roles** indicates your role, determining the privileges:
    -Guest, Can view public content only
    -User, Can run jobs/processors 
    -Expert User, Can edit, write & integrate processors + run jobs/processors 
    -Content Authority, Can publish shared content 
    -Admin, Full access