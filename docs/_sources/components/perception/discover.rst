...
.. image:: ../../images/perception_4.png
   :alt: CyberItaly Visualization and Analytics
   :width: 30%
...
* Guest public data, to access sampkle what-if scenarios run regarding specific Digital Twins for demonstration activities
* The main Digital Twin processors, to easily access what-if scenarios outputs
...
* *Open Data*, containing open data collections. *Note that this group might not be available*.
...
* *IRIDE CyberItaly*, containing specific Digital Twins input data, needed to run what-if scenarios
...
My storage in CyberItaly Visualization and Analytics provides a quick access to your storage, with the following storage types:
...
Some features, like uploading, downloading or removing data are available in CyberItaly Visualization and Analytics.

For the other features related to your storage, and further details for each storage type, please refer to :ref:`awareness`.

*TIP:* My storage in CyberItaly Visualization and Analytics allow to visualise the content of your storage in the map. For more details, see :ref:`visualise`.
